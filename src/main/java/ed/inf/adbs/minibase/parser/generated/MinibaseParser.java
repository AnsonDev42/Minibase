...
public class MinibaseParser extends Parser {
    ...
    public static class HeadContext extends ParserRuleContext {
        public TerminalNode ID_UPPER() {
            return getToken(MinibaseParser.ID_UPPER, 0);
        }
    ...
    public static class RelationalAtomContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MinibaseVisitor)
                return ((MinibaseVisitor<? extends T>) visitor).visitRelationalAtom(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ComparisonAtomContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MinibaseVisitor)
                return ((MinibaseVisitor<? extends T>) visitor).visitComparisonAtom(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class VariableContext extends ParserRuleContext {
        public TerminalNode ID_LOWER() {
            return getToken(MinibaseParser.ID_LOWER, 0);
        }
    ...
    public static class ConstantContext extends ParserRuleContext {
        public TerminalNode INT() {
            return getToken(MinibaseParser.INT, 0);
        }

        public TerminalNode STRING() {
            return getToken(MinibaseParser.STRING, 0);
        }
